# v8 - This version writes to a temp file first then renames to avoid external processes trying to read the file whilst we are writing to it
# v8 - This version seems to work 
