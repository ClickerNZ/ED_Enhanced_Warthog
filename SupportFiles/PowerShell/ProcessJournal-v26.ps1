# v26 – Process Journal using line-count tracking (Approach #1)
...
$rate  = 0
$volume= 75
[TTS]::SpeakText("Journal processor version 26 loading", $voice, $rate, $volume)

# Set window title
try { $host.UI.RawUI.WindowTitle = "Process Journal v26" } catch {}

# Load lookup maps
Import-MapFile -FilePath "C:\Thrustmaster\ED_TargetScript_Warthog\SupportFiles\PowerShell\Lookup\EDData.json"

Write-Host "ProcessJournal v26" -ForegroundColor Green
