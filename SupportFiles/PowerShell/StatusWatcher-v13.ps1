# v13 - using $FullPath instead of $FilePath in changed action statement...I seem to think we've been here before!
...
$onChanged = Register-ObjectEvent -InputObject $watcher -EventName Changed -Action {
    # Directly reference the known $FullPath instead of relying on eventArgs.FullPath
    try {
