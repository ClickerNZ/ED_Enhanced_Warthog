# v6 - Updated to process status.json at run time and then monitor for changes via FileSystemWatcher
# This version works when called from a batch file or command line using...
# powershell -ExecutionPolicy Bypass -File "C:\Thrustmaster\ED_TargetScript_Warthog\SupportFiles\PowerShell\StatusWatcher-v6.ps1"
